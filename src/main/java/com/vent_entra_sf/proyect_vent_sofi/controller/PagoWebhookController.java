...
public class PagoWebhookController {
    ...
    public ResponseEntity<String> webhook(@RequestBody Map<String, Object> body) {
        ...
        try {
            ...
            // 5️⃣Solo procesar si está aprobado
            ...
            // 7️⃣Evitar reprocesar si ya está pagada
            ...
            // 9️Guardar primero en base de datos
